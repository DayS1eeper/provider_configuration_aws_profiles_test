  ...
  provider_configurations = [
    {
      ...
      alias                = "aws_account",
      object_to_create_key = module.pcfg_v3_agent_aws_account_creds.object_path,
    },
    {
      id                   = scalr_provider_configuration.v3_agent_export_shell_variables.id,
      alias                = "export_shell_variables",
      object_to_create_key = module.pcfg_v3_agent_export_shell_variables_creds.object_path,
    },
    {
      id                   = scalr_provider_configuration.v3_agent_aws_service.id,
      alias                = "aws_service",
      object_to_create_key = "v3_agent_all/aws_service",
    },
  ]
}
