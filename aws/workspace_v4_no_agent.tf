  ...
  provider_configurations = [
    {
      ...
      alias                = "aws_account",
      object_to_create_key = module.pcfg_v4_no_agent_aws_account_creds.object_path,
    },
    {
      id                   = scalr_provider_configuration.v4_no_agent_export_shell_variables.id,
      alias                = "export_shell_variables",
      object_to_create_key = module.pcfg_v4_no_agent_export_shell_variables_creds.object_path,
    },
  ]
}
